<?php
    ...
    $anios              = $anios ?? [];
    $modulo_actual = $modulo_actual ?? 'cotizaciones';
?>
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <div class="dropdown">
                    ...
                    <button
                        id="btn-modulo"
                        class="btn btn-outline-primary btn-sm dropdown-toggle fw-bold"
                        type="button"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a
                                class="dropdown-item modulo-selector"
            ...
            <div class="icon">
                ...
                <svg
                    ...
                    <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-2.814a.75.75 0 10-1.22-.872l-3.236 4.53-1.545-1.545a.75.75 0 00-1.06 1.06l2.167 2.167a.75.75 0 001.14-.094l3.754-5.246z"/>
    ...
    <div class="col-md-6 col-xl-3">
        ...
        <div class="small-box text-bg-warning">
            ...
            <div class="inner">
                ...
                <h3 id="total_respaldo">
                    <?= $total_respaldo ?>
                </h3>

                <p id="titulo_card_3">
                    Cotizaciones respaldo
                </p>
